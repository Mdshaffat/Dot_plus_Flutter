...
class PatientOnlineDetailsFromTable extends StatefulWidget {
  final int patientId;
  const PatientOnlineDetailsFromTable({Key? key, required this.patientId})
      : super(key: key);

  @override
  State<PatientOnlineDetailsFromTable> createState() =>
      _PatientOnlineDetailsFromTableState();
}

class _PatientOnlineDetailsFromTableState
    extends State<PatientOnlineDetailsFromTable> {
                                ...
                                SizedBox(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                            physicalStat.heightFeet.toString() +
                                                " feet " +
