...
class PatientOnlineEditFromQRDetails extends StatefulWidget {
  final String patientID;
  const PatientOnlineEditFromQRDetails({Key? key, required this.patientID})
      : super(key: key);

  @override
  State<PatientOnlineEditFromQRDetails> createState() =>
      _PatientOnlineEditFromQRDetailsState();
}

class _PatientOnlineEditFromQRDetailsState
    extends State<PatientOnlineEditFromQRDetails> {
  int? id;
  int? patientId;
  ...
  void initState() {
    ...
    fetchHospitals();
    fetchDivision();
    pathcValue(int.parse(widget.patientID));
    setState(() {});
  }
