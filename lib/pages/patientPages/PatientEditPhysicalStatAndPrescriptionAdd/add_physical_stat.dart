...
class PhysicalStatAddFromQRDetails extends StatefulWidget {
  final int? patientid;
  const PhysicalStatAddFromQRDetails({Key? key, this.patientid})
      : super(key: key);

  @override
  State<PhysicalStatAddFromQRDetails> createState() =>
      _PhysicalStatAddFromQRDetailsState();
}

class _PhysicalStatAddFromQRDetailsState
    extends State<PhysicalStatAddFromQRDetails> {
