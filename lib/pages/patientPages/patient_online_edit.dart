...
class PatientOnlineEdit extends StatefulWidget {
  const PatientOnlineEdit({Key? key}) : super(key: key);

  @override
  State<PatientOnlineEdit> createState() => _PatientOnlineEditState();
}

class _PatientOnlineEditState extends State<PatientOnlineEdit> {
  int? id;
  int? patientId;
